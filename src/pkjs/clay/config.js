...
module.exports = [
  ...
  },
  {
    type: "text",
    defaultValue:
      'Contribute on <a href="https://github.com/mattrossman/forecaswatch2">GitHub!</a>',
  },
  {
    type: "section",
    items: [
      ...
      },
      {
        ...
        defaultValue: "24h",
        description:
          "Tip: go to Settings > Date & Time > Time Format on your watch to change the main time format",
        options: [
          {
            label: "12h",
            value: "12h",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        defaultValue: "#000000",
        description:
          "Black (default) means match date color, any other value overrides this.",
        sunlight: false,
        capabilities: ["COLOR"],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "<a href='https://darksky.net/dev/register'>Register a Dark Sky developer account</a> and paste your secret key here",
      },
      {
        type: "input",
        ...
        description:
          "<a href='https://openweathermap.org/'>Register an OpenWeatherMap account</a> and paste your API key here",
      },
      {
        type: "toggle",
        ...
        messageKey: "fetch",
        description:
          "Last successful fetch:<br><span id='lastFetchSpan'>Never :(</span>",
      },
      {
        type: "input",
        ...
        messageKey: "location",
        description:
          'Example: "Manhattan" or "123 Oak St Plainsville KY".<br><a href="https://locationiq.com/demo">Click here</a> to test out your location query.<br>To use GPS, leave this blank and ensure GPS is enabled on your device.',
        attributes: {
